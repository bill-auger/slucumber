...
ACTOR_MAP =
{
  :initiators => { :label => 'When the initiator:' , :options => { :default => INITIATORS } } ,
  :triggers   => { :label => 'Triggers an event:' , :options =>
                   { :default         => ["Trigger"] ,
                     ME_KIND          => AGENT_TRIGGERS ,
  ...
  :receivers  => { :label => 'Then the responder:' , :options =>
                   { :default         => ["Receiver"] ,
                     CLICK_KIND       => CLICK_RECEIVERS ,
  ...
  :responses  => { :label => 'Responds with:' , :options =>
                   { :default         => ["Response"] ,
                     CREATOR_KIND     => 'n/a' ,
                     OWNER_KIND       => 'n/a' ,
